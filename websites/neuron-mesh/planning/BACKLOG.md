...
| `ENV-009` | Publicación | Componer Neuron Mesh en `/` y Agent en `/agent/` en un único artefacto Pages | P0 | Terminado | GitHub Actions #35989129116 terminó en success. La raíz conserva las 14 rutas de Neuron Mesh; Agent usa base de subruta. Rutas públicas de ambas respondieron 200. |
| `ENV-010` | Publicación | Mover Neuron Mesh a `/neon-mesh/` sin romper su navegación | P0 | Terminado | Agent ocupa la raíz; Neuron Mesh bajo `/neon-mesh/`. Base, enlaces, recursos, canónicas y redirecciones HTML de antiguas páginas actualizados; Actions #35997797464 terminó en success y `/neon-mesh/`, `/neon-mesh/es/` respondieron 200. |

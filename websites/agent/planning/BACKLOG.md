...
| `AG-026` | Lectura Markdown | Publicar una única colección enlazada de Markdown interpretado para personas e IA | Por decidir | S10 rechazado; seleccionado S11 | Juan corrigió S10: no quiere una vista `.md` cruda para IA y otra HTML para personas. El índice y los 22 documentos ES/EN deben publicarse como HTML estático sencillo, desde Markdown real en el repo; todos los enlaces internos deben navegar entre páginas HTML. No publicar los `.md` fuente como segunda vista. |

...
3. Ejecuta `npm run setup` desde la raíz para instalar, por separado, las dependencias de `website/neuron-mesh/` y `websites/agent/`.
...
- `website/neuron-mesh/`: web existente. Su Scrum está en `website/neuron-mesh/planning/`.

...
| `ENV-010` | Publicación | Mover Neuron Mesh a `/neon-mesh/` sin romper su navegación | P0 | Seleccionado ENV-04 | Juan pidió Agent en la raíz y Neuron Mesh bajo la subruta escrita `/neon-mesh/`. Ajustar base, enlaces, recursos, canónicas y redirecciones de las antiguas rutas públicas; publicar y comprobar el resultado. |

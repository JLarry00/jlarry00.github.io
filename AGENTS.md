...
- En Agent, S12 dejó un análisis curado y aceptado del vídeo de reviews en `websites/agent/planning/reviews/S12-video-2026-09-23.md`. El vídeo y su transcripción íntegra son locales y no deben versionarse. S13 y S14 fijaron el árbol, la entrada documental desde el `AGENTS.md` humano y los enlaces entre archivos; `SOUL.md` es el About personal todavía provisional y `MEMORY.md` sigue aplazado. `AG-014` será la última tarea del producto.
